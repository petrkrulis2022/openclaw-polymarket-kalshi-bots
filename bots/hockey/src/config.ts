...
export const config = {
  ...
  // Most we'll pay above the pre-goal ask on a score-trigger BUY. The buy's
  // worst price = preGoalAsk + this (price units; 0.05 = 5¢). Keeps a late order
  // from chasing the post-goal repricing up toward 99¢.
